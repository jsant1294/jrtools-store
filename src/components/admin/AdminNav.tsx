...
import { Package, ClipboardList, Wrench, ExternalLink, Image, CreditCard, Sparkles } from "lucide-react";
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-forge-600 bg-forge-900/95 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center gap-2 px-4 py-2">
        ...
        {tab("/admin/ai", path.startsWith("/admin/ai"), <Sparkles className="h-4 w-4" />, "AI / IA")}
